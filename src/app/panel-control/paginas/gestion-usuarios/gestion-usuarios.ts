...
// --- CORRECCIÓN CLAVE ---
import { UserProfile } from '../../modelos/usuario'; // Se corrige la ruta de importación
import { TablaGenerica, ColumnConfig } from '../../../compartido/tabla-generica/tabla-generica';
import { MatDialog } from '@angular/material/dialog';
import { MatSnackBar } from '@angular/material/snack-bar';
import { FormularioUsuarioComponent } from '../../componentes/formulario-usuario/formulario-usuario';
